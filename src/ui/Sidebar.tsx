...
<aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div className="h-full px-3 py-12 overflow-y-auto bg-zinc-800 dark:bg-gray-800">
      <ul className="space-y-2 font-medium">
         <li>
            <a href="#" className="flex items-center p-2 text-white-900 rounded-lg dark:text-white hover:bg-yellow-400 hover:text-zinc-800 dark:hover:bg-gray-700 group ">
               <span className="ms-3">Stone Quarry</span>
            </a>
         </li>
